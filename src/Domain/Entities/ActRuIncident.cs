...
public partial class ActRuIncident
{
    ...
    public virtual ICollection<ActRuIncident> InverseCauseIncident { get; set; } = new List<ActRuIncident>();

    public virtual ICollection<ActRuIncident> InverseRootCauseIncident { get; set; } = new List<ActRuIncident>();
